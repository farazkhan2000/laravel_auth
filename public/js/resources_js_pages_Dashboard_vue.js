      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/logged-in-user', {
              headers: {
...
var _hoisted_1 = {
  "class": "bg-dark text-light align-content-center",
  style: {
    "height": "100vh"
  }
};
